...
def get_account_settings(requesting_user, username=None, configuration=None, view=None):
    ...
    use_filter = not (has_full_access and view != 'shared')

    return AccountFullUserProfileReadOnlySerializer(existing_user, configuration=configuration, use_filter=use_filter).data
