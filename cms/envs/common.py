...
EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = ''
DEFAULT_FROM_EMAIL = 'info@edu4africa.com'
DEFAULT_FEEDBACK_EMAIL = 'info@edu4africa.com'
SERVER_EMAIL = 'info@edu4africa.com'
ADMINS = ()
MANAGERS = ADMINS
...
TIME_ZONE = 'Africa/Accra'  # http://en.wikipedia.org/wiki/List_of_tz_zones_by_name
